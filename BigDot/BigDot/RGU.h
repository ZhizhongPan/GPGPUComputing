...
//
cl_int
RGUGetPlatformID(cl_platform_id* clSelectedPlatformID){
    char chBuffer[1024];
    ...
    *clSelectedPlatformID = NULL;
    ...
    if(*clSelectedPlatformID==NULL)
        fprintf(stderr,"NVIDIA has disappeared.\n");
    free(clPlatformIDs);
    return CL_SUCCESS;
}
...
char*
RGULoadProgSource(const char* filename,const char* preamble,size_t* sz)
{
    FILE* fptr = NULL;
